...
In this tutorial, we will forecast measles incidence using both the semi-mechanistic TSIR model and the LASSO machine learning model. We will employ the seminal England and Wales pre-vaccination bi-weekly measles dataset (a description of which can be found \href{https://doi.org/10.1371/journal.pcbi.1010251}{here}). 

This tutorial employs methods developed in \href{https://doi.org/10.1371/journal.pcbi.1010251}{this paper} by Lau et al.. 
